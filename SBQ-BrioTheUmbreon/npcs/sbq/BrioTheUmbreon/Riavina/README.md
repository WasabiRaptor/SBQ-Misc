...
The `dialogueTree` table points to all the lines the NPC will have for various interactions which are within `sbq/BrioTheUmbreon/Riavina.dialogueTree`, you can either define unique lines to your NPC by editing or adding lines to the contexts already there, all the dialogue itself should be contained in the `sbq/BrioTheUmbreon/Riavina.dialogue` file
...
`node sortDialogue.js 'npcs/sbq/BrioTheUmbreon/Riavina/npc.dialogueTree' 'npcs/sbq/BrioTheUmbreon/Riavina/npc.dialogue'`
